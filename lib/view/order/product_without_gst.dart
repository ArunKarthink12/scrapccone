...
class ProductDetailsWithoutGst extends StatefulWidget {
  const ProductDetailsWithoutGst({Key? key}) : super(key: key);
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: Row(children: [
                    Flexible(
                      child: Text(
                        withoutGstController
                            .withoutgstorder[0].orderDetails![0].category
                            .toString(),
                        style: GoogleFonts.jost(
                            textStyle: TextStyle(
                                fontSize: 11.0.sp,
                ...
                child: SizedBox(
                  ...
                  child: Row(children: [
                    Flexible(
                      child: Text(
                        withoutGstController
                            .withoutgstorder[0].orderDetails![0].subcategory
                            .toString(),
                        style: GoogleFonts.jost(
                            textStyle: TextStyle(
                                fontSize: 11.0.sp,
